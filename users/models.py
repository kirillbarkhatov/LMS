...
class Payment(models.Model):
    ...
    course = models.ForeignKey(Course, on_delete=models.CASCADE, related_name="payments_for_course", verbose_name="Курс")
    lesson = models.ForeignKey(Lesson, on_delete=models.CASCADE, related_name="payments_for_lesson", verbose_name="Урок")
